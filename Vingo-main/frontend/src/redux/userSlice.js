...
import { createSlice } from "@reduxjs/toolkit"; // ❌ current hata diya (unused tha)
...
const userSlice = createSlice({
  ...
  initialState: {
    ...
    // ❌ REMOVED: socket (non-serializable tha)
    // socket: null
  },
